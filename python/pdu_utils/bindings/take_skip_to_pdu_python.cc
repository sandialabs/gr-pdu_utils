...
/* BINDTOOL_HEADER_FILE_HASH(2356577cb8775b6337b277e6a477e8d9)                     */
/***********************************************************************************/
...
void bind_take_skip_to_pdu_template(py::module& m, const char* classname)
{
    ...
    using take_skip_to_pdu = ::gr::pdu_utils::take_skip_to_pdu<T>;
    ...
    py::class_<take_skip_to_pdu,
        ...
        .def(py::init(&gr::pdu_utils::take_skip_to_pdu<T>::make),
             py::arg("take"),
             py::arg("skip"))
        .def("set_take", &take_skip_to_pdu::set_take, py::arg("take"))
        .def("set_skip", &take_skip_to_pdu::set_skip, py::arg("skip"));
}
