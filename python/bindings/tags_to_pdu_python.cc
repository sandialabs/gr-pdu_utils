...
/* BINDTOOL_HEADER_FILE_HASH(c74868387ea206736c6b3efba21c8f85)                     */
/***********************************************************************************/
...
{
    using tags_to_pdu = ::gr::pdu_utils::tags_to_pdu<T>;
    ...
    py::class_<tags_to_pdu,
        ...
        .def(py::init(&gr::pdu_utils::tags_to_pdu<T>::make),
             py::arg("start_tag"),
             py::arg("end_tag"),
             py::arg("max_pdu_size"),
             py::arg("samp_rate"),
        ...
        .def("publish_sob_msgs", &tags_to_pdu::publish_sob_msgs, py::arg("pub"))
